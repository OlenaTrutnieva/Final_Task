...
public class TabletPC extends Appliance{
	...
	public TabletPC(String applianceName, double price, int quantity, double batteryCapacity, int memoryRom, int displayInches, int flashMemoryCapacity, String color) {
